...
describe("<CreateItem/>", () => {
  ...
  it("uploads a file when changed", async () => {
    ...
    await wait();
    // grabbing an instance of the component to peak into it's state:
  ...
  it("handles state updating", async () => {
    ...
    wrapper.find("#description").simulate("change", {
      target: { value: "This is a realy nice item", name: "description" }
    });
    expect(wrapper.find("CreateItem").instance().state).toMatchObject({
      title: "Testing",
      price: 50000,
      description: "This is a realy nice item"
    });
  });
